...
[camunda-archetype-ejb-war-7.14.0](https://docs.camunda.org/manual/latest/user-guide/process-applications/maven-archetypes/).
...
### Unit Test
You can run the JUnit test [ProcessTest](src/test/java/org/logistics/logistics_storefront_bpm/ProcessTest.java) in your IDE or using:
...
<!-- Tweet
New @Camunda example: Camunda BPM Process Application - A Process Application for [Camunda BPM](http://docs.camunda.org). https://github.com/camunda-consulting/code/tree/master/snippets/logistics-storefront-bpm
-->
